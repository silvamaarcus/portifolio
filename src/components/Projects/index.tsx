        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-12">
          ...
          <div className="col-span-12 sm:col-span-4">
            <a href="https://forest-page-pi.vercel.app/" target="_blank">
              <div className="border-soft-black group relative flex cursor-pointer flex-col items-center justify-center overflow-hidden rounded-md border-4 bg-white/1 text-center backdrop-blur-md hover:border-primary transition-all duration-700">
                <img
                  src="/public/img/project_1.png"
                  alt="Forest"
